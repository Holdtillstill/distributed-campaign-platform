...
Raw visitor events are intended for short retention and daily digesting. Public documentation, screenshots, and repository content must avoid personal emails, phone numbers, cloud account identifiers, webhook URLs, ARNs, hosted zone IDs, and private infrastructure endpoints.
